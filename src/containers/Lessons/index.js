...
export default class Lessons extends React.PureComponent {
  ...
  getCourseStudent = () => {
    fetch('https://testbean2-env.us-east-1.elasticbeanstalk.com/api/getCourseStudent/' + this.props.match.params.id + '/' + this.props.match.params.uid, {
      method: 'GET',
      headers: {
  ...
  approveAnswer = (question, i) => {
    fetch('https://testbean2-env.us-east-1.elasticbeanstalk.com/api/approveAnswer/' + question.id + '/' + this.props.match.params.uid + '/' + i, {
      method: 'GET',
      headers: { 'Authorization': 'Bearer ' + this.state.token }
    })
      .then((response) => {
  ...
  completeLecture = () => {
    ...
    fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/completeLecture", {
      method: 'POST',
      body: data,
      headers: { 'Authorization': 'Bearer ' + this.state.token }
    })
