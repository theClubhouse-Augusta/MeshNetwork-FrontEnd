      ...
      <div className="spaceSignUpcontainer">
        ...
        <main className="spaceSignUpMain">
          ...
          <div className="spaceSignUpContainer">
            ...
            >Confirm New Space</FlatButton>
            <Link to={'/spaces'} style={{ alignSelf: 'center', width: '80%' }}>
              <FlatButton style={{ width: '100%', backgroundColor: '#FFFFFF', padding: '10px', marginTop: '30px', color: '#ff4d58', fontWeight: 'bold', border: '1px solid #CCCCCC', paddingTop: '15px', paddingBottom: '10px' }} >
