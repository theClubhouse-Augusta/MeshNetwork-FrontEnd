...
export default class Ask extends React.PureComponent {
  ...
  getQuestions = () => {
    ...
    if (this.state.currentPage !== this.state.lastPage) {
      fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/getQuestions/30?page=" + this.state.nextPage, {
        method: 'GET',
      })
  ...
  search = () => {
    ...
    fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/searchQuestions", {
      method: 'POST',
      body: data
    })
      .then(response => response.json())
