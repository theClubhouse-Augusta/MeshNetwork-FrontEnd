...
export default class Discover extends React.PureComponent {
  ...
  showCategories = categoryID => {
    fetch(
      "https://testbean2-env.us-east-1.elasticbeanstalk.com/api/showCategory/" +
      categoryID +
      "/Challenges",
      {
        method: "GET"
  ...
  getChallenges = () => {
    ...
    if (this.state.currentPage !== this.state.lastPage) {
      fetch(
        "https://testbean2-env.us-east-1.elasticbeanstalk.com/api/getChallenges/30?page=" +
        this.state.nextPage,
        {
          method: "GET"
        }
  ...
  search = () => {
    ...
    fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/searchChallenges", {
      method: "POST",
      body: data
    })
      .then(response => response.json())
