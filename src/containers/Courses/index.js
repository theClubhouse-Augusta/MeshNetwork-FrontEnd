...
export default class Courses extends React.PureComponent {
  ...
  getCourses = (category = 0) => {
    ...
    fetch(`https://testbean2-env.us-east-1.elasticbeanstalk.com/api/getCourses/${category}/${this.state.count}?page=${this.state.page}`)
      .then(response => {
  ...
  searchCourses = () => {
    ...
    fetch('https://testbean2-env.us-east-1.elasticbeanstalk.com/api/searchCourse', {
      method: 'POST',
      body: data
    })
      .then(response => response.json())
