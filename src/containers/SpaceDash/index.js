...
const spaceInfoAPI = 'http://testbean2-env.us-east-1.elasticbeanstalk.com/api/workspace/auth/';
class SpaceDash extends React.Component {
  ...
  loadJoins = () => {
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/joins/${this.props.match.params.id}`, {})
  ...
  loadEventMetrics = () => {
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/events/metrics/${this.props.match.params.id}`, {})
      .then(response => response.json())
      .then(({
        data,
  ...
  loadAppearances = () => {
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/appearances/${this.props.match.params.id}`, {})
      .then(response => response.json())
      .then(({
        data,
  ...
  getMonthlyBalance = () => {
    ...
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/balance/current/${lastMonth}/${now}`, {
      headers: { Authorization: `Bearer ${localStorage['token']}` }
    })
      .then(response => response.json())
      .then(({
  ...
  getMonthlyCustomerCount = () => {
    const now = moment().format('X');
    const lastMonth = moment().format('X') - (86400 * 30);
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/customers/month/${lastMonth}/${now}`, {
      headers: { Authorization: `Bearer ${localStorage['token']}` }
    })
      .then(response => response.json())
      .then(({
  ...
  getSpaceStats = (id) => {
    fetch('http://testbean2-env.us-east-1.elasticbeanstalk.com/api/space/metrics/' + id)
      .then(response => response.json())
      .then(({
        memberCount,
        eventCount,
  ...
  getSpaceUsers = (id) => {
    fetch('http://testbean2-env.us-east-1.elasticbeanstalk.com/api/getDashboardUsers/' + id, {
      headers: {
  ...
  getSpaceEvents = (id) => {
    fetch('http://testbean2-env.us-east-1.elasticbeanstalk.com/api/events/' + id)
      .then(response => response.json())
      .then(spaceEvents => {
  ...
  storePhoto = (file) => {
    ...
    fetch('http://testbean2-env.us-east-1.elasticbeanstalk.com/api/photos', {
      method: 'POST',
      body: data,
  ...
  deleteEvent = (eventID, index) => {
    fetch(`http://testbean2-env.us-east-1.elasticbeanstalk.com/api/event/delete/${eventID}`, {
      headers: { Authorization: `Bearer ${localStorage['token']}` }
    })
      .then(response => response.json())
      .then(({ success, error }) => {
