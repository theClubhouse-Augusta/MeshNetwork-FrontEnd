...
export default class Replies extends React.PureComponent {
  ...
  getQuestion = () => {
    fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/showQuestion/" + this.props.match.params.id, {
      method: 'GET'
    })
  ...
  getReplies = () => {
    ...
    if (this.state.currentPage !== this.state.lastPage) {
      fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/getReplies/" + this.props.match.params.id + '?page=' + this.state.nextPage, {
        method: 'GET'
      })
        .then(response => response.json())
        .then(json => {
  ...
  storeReply = () => {
    ...
    fetch("https://testbean2-env.us-east-1.elasticbeanstalk.com/api/storeReply/", {
      method: 'POST',
      body: data,
