...
export default class Replies extends React.PureComponent {
  ...
  getQuestion = () => {
    fetch("https://suggestify.io/api/showQuestion/" + this.props.match.params.id, {
      method: 'GET'
    })
  ...
  getReplies = () => {
    ...
    if (this.state.currentPage !== this.state.lastPage) {
      fetch("https://suggestify.io/api/getReplies/" + this.props.match.params.id + '?page=' + this.state.nextPage, {
        method: 'GET'
      })
        .then(response => response.json())
        .then(json => {
  ...
  storeReply = () => {
    ...
    fetch("https://suggestify.io/api/storeReply/", {
      method: 'POST',
      body: data,
