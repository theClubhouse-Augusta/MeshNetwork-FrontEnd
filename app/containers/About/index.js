      ...
      <div className="container">
        ...
        <header>
          ...
          <div className="aboutBanner">
            <div className="aboutHeaderContentTitle">
              About the Mesh Network
            </div>
            <div className="aboutHeaderContentSubtitle">
          ...
          <div className="aboutMainContainer">
            <div className="aboutMainRow">
              ...
              <div className="aboutMainContent">
                ...
                models with different focuses. These models include Makerspaces,
                Coworking Spaces, Business Incubators.
              </div>
            </div>
            <div className="aboutMainMiddleRow">
              <div className="aboutMainContent">
                <div className="aboutMainContentTitle">
                  Why do Entrepreneurs need Collaborative Incubators?
                </div>
                Most of our success is the result of the connections we have to
                people and resources. The Mesh Network helps local organizers
                grow larger communities, and helps connect entrepreneurs to
