export default class DateUtils {
   ...
   */
  removeDuplicateDate = (previousDateSelections, currentDateSelection) => { 
   ...
   */
  removeDuplicateStart = (startTimes, start) => {
   ...
   */
  removeDuplicateEnd = (endTimes, end) => {
   ...
   * @param {Array.<{day:string, index:number}>} dates 
   */
  multiDayTimeErrors = (startTimes, endTimes, dates) => {
   ...
   * @param {string} day 
   */
  timeError = (startTime, endTime, day) => {
