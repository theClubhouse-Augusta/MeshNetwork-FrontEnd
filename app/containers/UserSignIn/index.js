            ...
            <div className="userSignIncontainer">
                ...
                <main className="userSignInMain">
                    {!this.state.forgotPassword &&
                        <React.Fragment>
                            <TextField  fullWidth margin="normal" style={{maxWidth: '300px'}} label="E-mail" value={this.state.email} onChange={this.handleEmail}  />
                            <TextField fullWidth margin="normal" style={{maxWidth: '300px'}} label="Password" value={this.state.password} onChange={this.handlePassword} type="password" />
                            <FlatButton style={{ width: '60%',  maxWidth: '300px',backgroundColor: "#ff4d58", margin: '30px 15px 15px 15px', color: '#FFFFFF' }} onClick={this.signIn}>Sign In</FlatButton>
                    ...
                    {this.state.forgotPassword &&
                        <React.Fragment>
                            <TextField fullWidth margin="normal" style={{maxWidth: '300px'}} label="E-mail" value={this.state.email} onChange={this.handleEmail} />
                            <FlatButton style={{width: '60%',  maxWidth: '300px',  backgroundColor: "#ff4d58", margin: '30px 15px 15px 15px', color: '#FFFFFF' }} onClick={this.sendResetEmail}>Reset Password</FlatButton>
