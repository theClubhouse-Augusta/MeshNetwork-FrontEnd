    ...
    .then(function(json) {
      if(json.detail) {
        ...
        this.setState({
          ...
          courseInstructorAvatarPreview:'https://houseofhackers.me/media/' + json.course.courseInstructorAvatar,
          courseImagePreview:'https://houseofhackers.me/media/' + json.course.courseImage,
